...
public interface AcsSms extends Sms, SmsExt {
	 ...
	 */
	CommonResponse commonSend(String templateCode, String templateParamJson, String signName, String phoneNumber) throws ClientException;
	 ...
	 * @throws ClientException 短信发送异常
	 */
	default CommonResponse commonSend(String templateCode, String templateParamJson, String phoneNumber) throws ClientException {
		return this.commonSend(templateCode, templateParamJson, getSignName(), phoneNumber);
	}
