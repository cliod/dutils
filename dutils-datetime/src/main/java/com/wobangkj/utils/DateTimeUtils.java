...
public class DateTimeUtils extends org.apache.commons.lang3.time.DateUtils {
	...
	public static boolean isDatetimeInToday(@NotNull String datetime) {
		...
		long now;
		if (FORMAT_DATETIME.getPattern().length() == datetime.length()) {
	...
	public static boolean isDatetimeInThisMonth(@NotNull String datetime) {
		...
		String date;
		String now = getNow(FORMAT_DATE_DEFAULT.getPattern());
		if (len == FORMAT_DATETIME_DEFAULT.getPattern().length() || len == FORMAT_DATE_DEFAULT.getPattern().length()) {
	...
	public static long getDaySub(String dateStr1, String dateStr2) {
		LocalDate date1 = LocalDate.parse(dateStr1, DateTimeFormatter.ofPattern(FORMAT_DATETIME_DEFAULT.getPattern()));
		LocalDate date2 = LocalDate.parse(dateStr2, DateTimeFormatter.ofPattern(FORMAT_DATETIME_DEFAULT.getPattern()));
	...
	public static long getMidnight() {
		String start = getNow(FORMAT_DATE_DEFAULT.getPattern()) + " 00:00:00";
	...
	public static String convertToDefaultDateTimeStr(@NotNull Date date) {
		return date
				...
				.format(DateTimeFormatter.ofPattern(FORMAT_DATETIME_DEFAULT.getPattern()));
	}
	...
	public static String convertDefaultDateTimeStr(@NotNull String datetime) {
		String result;
		if (datetime.length() == FORMAT_DATE.getPattern().length() || datetime.length() == FORMAT_DATETIME.getPattern().length()) {
			result = datetime.substring(0, 4) + "-" +
					datetime.substring(4, 6) + "-" +
					datetime.substring(6, 8);
			if (datetime.length() == FORMAT_DATETIME.getPattern().length()) {
				result += " " +
	...
	public static Timestamp toSqlTimestamp(String sDate) {
		...
		if (sDate.length() != FORMAT_DATE_DEFAULT.getPattern().length()
				&& sDate.length() != FORMAT_DATETIME_DEFAULT.getPattern().length()) {
			return null;
		}
		return toSqlTimestamp(sDate,
				sDate.length() == FORMAT_DATE_DEFAULT.getPattern().length()
						? FORMAT_DATE_DEFAULT.getPattern()
						: FORMAT_DATETIME_DEFAULT.getPattern());
	 ...
	 *
	 * @param sDate Date string
	 * @param sFmt  Date format DATE_FORMAT_DATEONLY/FORMAT_DATETIME_DEFAULT.getPattern()
	 * @return 时间戳
	 */
	public static Timestamp toSqlTimestamp(String sDate, String sFmt) {
		...
		if (sFmt.equals(FORMAT_DATETIME_DEFAULT.getPattern())) {
			temp = sDate.replace('/', '-');
			temp = temp + ".000000000";
		} else if (sFmt.equals(FORMAT_DATE_DEFAULT.getPattern())) {
			temp = sDate.replace('/', '-');
	 ...
	 * @param sFmt Date format , DATE_FORMAT_DATEONLY or FORMAT_DATETIME_DEFAULT.getPattern()
	 * @return 字符串
	 */
	@NotNull
	...
	public static String toSqlTimestampString(Timestamp dt) {
		...
		String temp = toSqlTimestampString(dt, FORMAT_DATETIME_DEFAULT.getPattern());
	 ...
	 *
	 * @param dt   java.sql.Timestamp instance
	 * @param sFmt Date 格式，DATE_FORMAT_DATE_ONLY/FORMAT_DATETIME_DEFAULT.getPattern()/DATE_FORMAT_SESSION
	 * @return 字符串
	 */
	public static String toSqlTimestampString(Timestamp dt, String sFmt) {
		...
		if (sFmt.equals(FORMAT_DATETIME_DEFAULT.getPattern()) || sFmt.equals(FORMAT_DATE_DEFAULT.getPattern())) {
	...
	public static String timestampToStringYMD(Timestamp timestamp) {
		SimpleDateFormat sdf = new SimpleDateFormat(FORMAT_DATE_DEFAULT.getPattern());
	...
	public static String formatDate(Date date) {
		...
		return formatDate(date, FORMAT_DATETIME_DEFAULT.getPattern());
	}
	...
	public static String nowDate() {
		return formatDate(new Date(), FORMAT_DATE_DEFAULT.getPattern());
	}
	...
	public static String nowTime() {
		return formatDate(new Date(), FORMAT_DATETIME.getPattern());
	}
	...
	public static String getYesterday() {
		return formatDate(getDate(-1), FORMAT_DATE_DEFAULT.getPattern());
	}
