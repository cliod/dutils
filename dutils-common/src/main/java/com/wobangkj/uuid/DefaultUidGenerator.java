...
public class DefaultUidGenerator implements UidGenerator {
	...
	@Override
	public synchronized String parseUid(long uid) {
	...
	public synchronized void setEpochStr(String epochStr) throws ParseException {
		if (StringUtils.isNotBlank(epochStr)) {
			this.epochStr = epochStr;
			this.epochSeconds = TimeUnit.MILLISECONDS.toSeconds(format.parse(epochStr).getTime());
		}
	}
}
