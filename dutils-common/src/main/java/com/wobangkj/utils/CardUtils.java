...
public class CardUtils {
	...
	public static final HashMap<String, String> map = new HashMap<>(64);
	//BIN号
	 ...
	 */
	public static boolean validateIdCard(String idStr) {
		...
		if (!MatchUtils.isDate(strYear + "-" + strMonth + "-" + strDay)) {
			// 身份证生日无效。
			return false;
		}
	...
	public static char getBankCardCheckCode(String nonCheckCodeCardId) {
		...
		int cardLength = nonCheckCodeCardId.trim().length();
		if (cardLength == 0 || !nonCheckCodeCardId.matches("\\d+")) {
			throw new IllegalArgumentException("请输入有效的银行卡号!");
		}
	 ...
	 * 通过银行卡号获取银行卡所属银行名称
	 */
	public static String getNameBank(String idCard) {
		int index = -1;
