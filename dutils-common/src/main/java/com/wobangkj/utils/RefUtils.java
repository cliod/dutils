...
public class RefUtils {
	 ...
	 * @return 值
	 */
	public static @NotNull Maps<String, Object> getFieldValues(@NotNull Object obj) throws IllegalAccessException {
	 ...
	 * @return 值
	 */
	public static @NotNull Maps<String, Object> getFieldValues(@NotNull Object obj, Integer... excludeMods) throws IllegalAccessException {
	 ...
	 * @return 值
	 */
	public static @NotNull Maps<String, Object> getFieldValues(@NotNull Object obj, Collection<Integer> excludeMods) throws IllegalAccessException {
		Maps<String, Object> map = new Res();
		Field[] fields = obj.getClass().getDeclaredFields();
		for (Field field : fields) {
			if (excludeMods.contains(field.getModifiers())) continue;
			field.setAccessible(true);
	 ...
	 * @return 值
	 */
	public static @NotNull Maps<String, Object> getFieldValues(@NotNull Object obj, String... excludeFieldNames) throws IllegalAccessException {
	 ...
	 * @return 值
	 */
	public static @NotNull Maps<String, Object> getFieldValues(@NotNull Object obj, List<String> excludeFieldNames) throws IllegalAccessException {
		Maps<String, Object> map = new Res();
		Field[] fields = obj.getClass().getDeclaredFields();
		for (Field field : fields) {
			if (excludeFieldNames.contains(field.getName()) || excludeFieldNames.contains(covert.apply(field.getName()))) continue;
			field.setAccessible(true);
			map.put(covert.apply(field.getName()), field.get(obj));
		}
		return map;
